<?php
	...
	$result = $mysqli->query("SELECT id, category, name, author, picture, short_description, raiting, `date`, `full_description`, `num_steps`, `video_link`, `instruction` FROM instructions WHERE id='".$_GET['id']."' LIMIT 1");
